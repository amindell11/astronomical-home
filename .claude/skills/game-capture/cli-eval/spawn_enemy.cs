var units = UnityEngine.Object.FindObjectsByType<Substrate.Services.Units.UnitService>(UnityEngine.FindObjectsSortMode.None);
...
var pos = Substrate.GamePlane.PlanePointToWorld(new UnityEngine.Vector2(25f, 10f));
var ship = units[0].SpawnShip(shipPrefab, pilot, 1, pos, Substrate.GamePlane.Rotation);
