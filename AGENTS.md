...
- Chat titles follow the lifecycle grammar (skill → "Chat title lifecycle"): update the ledger Title board and sweep peers' board titles at every ledger-writing transition; a plain title marks a discussion chat.
