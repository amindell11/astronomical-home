...
**Usage:**
1. Select a GameObject in the Scene hierarchy (e.g., LockOnIndicator, ShieldUI, or weapon mount)
...
**Purpose:** Monitor UI components (LockOnIndicator, ShieldUI) for event subscription issues and state changes.

**Usage:**
1. Select a GameObject with LockOnIndicator or ShieldUI component
...
4. **Add ComponentStateDiagnostics to child objects:**
   ...
   - Repeat for ShieldUI and LockOnIndicator if present

5. **Add UIDiagnostics to UI elements:**
   - Find ShieldUI GameObject (if present)
