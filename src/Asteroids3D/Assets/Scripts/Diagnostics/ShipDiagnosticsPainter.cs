...
namespace Game.Diagnostics
{
    ...
    public sealed class ShipDiagnosticsPainter : IDiagnosticPainter
    {
        ...
        public ShipDiagnosticsPainter(Ship a, Ship b, IProjectileService projectiles)
        {
            this.a = a;
            this.b = b;
        ...
        public string Name => DiagnosticPainters.ShipDiagnostics;

        public void Paint(IDiagnosticCanvas canvas) => Draw(canvas, a, b, projectiles);

        public static void Draw(IDiagnosticCanvas ctx, Ship a, Ship b, IProjectileService projectiles)
        {
        ...
        private static void DrawShip(IDiagnosticCanvas ctx, Ship ship, Ship enemy, Color color)
        {
        ...
        private static void DrawLos(IDiagnosticCanvas ctx, Ship a, Ship b)
        {
            if (!a || !b) return;
        ...
        private static void DrawProjectiles(IDiagnosticCanvas ctx, IProjectileService projectiles)
        {
