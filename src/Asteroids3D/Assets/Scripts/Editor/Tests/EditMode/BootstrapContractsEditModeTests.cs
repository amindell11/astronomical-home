...
namespace Tests.EditMode
{
    public class BootstrapContractsEditModeTests
    {
        ...
        {
            var ev = typeof(ISectorManager).GetEvent("OnSectorComplete");
        ...
        {
            var method = typeof(ISectorManager).GetMethod("Initialize");
            ...
            Assert.AreEqual(typeof(SectorConfigSO), parameters[1].ParameterType);
        }

        [Test]
        public void ISectorManager_HasSetupAndTeardownCoroutines()
        {
            var setup = typeof(ISectorManager).GetMethod("Setup");
            Assert.IsNotNull(setup, "ISectorManager must declare Setup");
            Assert.AreEqual(typeof(IEnumerator), setup.ReturnType);

            var teardown = typeof(ISectorManager).GetMethod("Teardown");
        ...
        {
            Assert.IsTrue(typeof(SectorManager).IsAbstract,
        ...
        {
            Assert.IsTrue(typeof(ISectorManager).IsAssignableFrom(typeof(SectorManager)),
        ...
        {
            Assert.IsTrue(typeof(MonoBehaviour).IsAssignableFrom(typeof(SectorManager)),
        ...
        {
            Assert.IsTrue(typeof(SectorManager).IsAssignableFrom(typeof(CombatSectorManager)),
        ...
        {
            Assert.IsFalse(typeof(CombatSectorManager).IsAbstract,
        ...
        {
            Assert.IsTrue(typeof(ScriptableObject).IsAssignableFrom(typeof(SectorConfigSO)),
        ...
        {
            var type = typeof(SectorConfigSO);
