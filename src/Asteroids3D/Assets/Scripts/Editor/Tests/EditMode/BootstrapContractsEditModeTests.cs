...
namespace Tests.EditMode
{
    ...
    public class BootstrapContractsEditModeTests
    {
        ...
        public void SessionRig_TakesInjectedDeathCallback_NoRestartEvent()
        {
            ...
            Assert.AreEqual(typeof(Action<ShipId, global::Damage.DamageInfo>), hook.PropertyType);
            ...
            Assert.AreEqual(typeof(Action<ShipId, global::Damage.DamageInfo>), parameters[2].ParameterType);
        }
