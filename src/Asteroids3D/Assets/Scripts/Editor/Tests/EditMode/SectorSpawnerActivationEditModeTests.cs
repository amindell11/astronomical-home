...
namespace Tests.EditMode
{
    ...
    public class SectorSpawnerActivationEditModeTests
    {
        ...
        public void EmptyToken_ProducesAtBuild()
        {
            ...
            Drive(spawner.Build(new SectorBuildContext(null, null, default, null, null, new SectorEventBus())));
        ...
        public void Token_DefersProduction_ToExactlyOneLatch()
        {
            ...
            Drive(spawner.Build(new SectorBuildContext(null, null, default, null, null, bus)));
