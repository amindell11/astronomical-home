...
namespace Game.Sectors
{
    ...
    /// static lookup. <see cref="Player"/> is null until the sector builds it (set by
    /// <c>PlaySector</c> before module setup); it is the only dependency that cannot be a dragged
    /// serialized reference because it is built at runtime.
    /// </summary>
