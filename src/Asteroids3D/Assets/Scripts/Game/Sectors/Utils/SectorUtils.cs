...
namespace Game.Sectors.Utils
{
    ...
    {
        public static Ship BuildAndWirePlayer(Ship playerTemplate, Commander playerCommander,FrameSettings shipSettings, int team, Vector2  playerSpawnPosition, IGameServices services)
        {
