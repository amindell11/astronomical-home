...
{
    /// <summary>The frozen arc-gate eval constants (#492): training seed, the 20 pinned held-out seeds (disjoint from training; never a tuning set), the pinned inference seed, and the Wilson bound the gate reads.</summary>
