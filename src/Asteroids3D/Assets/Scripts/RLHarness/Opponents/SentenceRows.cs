...
{
    /// <summary>The six session-confirmed tactic-bingo rows (doc/Feature_Plans/Intent_Grammar.md §Stage A brief, fork 3); the other bingo rows are rig-only by ruling.</summary>
