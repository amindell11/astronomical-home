...
using UnityEditor;
using UnityEngine;
//TODO refactor damage class into shield and health classes
namespace Ships
{
    public class Damage : MonoBehaviour, IDamageable
    {
        ...
        public event Action<Ships.Ship, Ships.Ship> OnDeath; // Passes the victim and killer Ship components
        ...
        public Ships.Ship  LastAttacker {get; private set;}
        private Ships.Ship myShip;
        ...
        private void Awake()
        {
            myShip = GetComponent<Ships.Ship>();
        ...
        {
            if (!attacker) return;
            var attackShip = attacker.GetComponentInParent<Ships.Ship>();
