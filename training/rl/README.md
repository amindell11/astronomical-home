...
$env:RL_EVAL_PROBES = "gate,facing(wFacing=5)"   # comma-separated "name" or "name(key=value,...)" probe tokens writing per-probe sidecars; "" for none; omit for the default "gate"
