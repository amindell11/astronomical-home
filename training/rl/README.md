...
$env:RL_HARNESS_PAINTERS = "ship-diagnostics,policy"   # comma-separated painter/preset names drawn onto filmed frames; presets expand + dedupe; omit for NONE (nothing drawn). Painters: ship-diagnostics, policy, scout-scan, lock-on; presets: everything
